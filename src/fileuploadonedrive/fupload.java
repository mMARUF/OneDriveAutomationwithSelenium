...
public static void main(String[] args) throws InterruptedException, Exception {
	   ...
	   // driver.findElement(By.xpath("//span[text()='Files']")).sendKeys("C:\\Users\\maruf.rahman\\Desktop\\demo.txt");
	    ...
	    Runtime.getRuntime().exec("D:\\FileUploadScript.exe");// Opening the exe file made by AutoIT to input the file path into Windows Explorer and press OPEN 
	    Thread.sleep(3000);
	   ...
	   // driver.findElement(By.xpath("//span[text()='Files']")).sendKeys("C:\\Users\\maruf.rahman\\Desktop\\demo.txt");
	    ...
	    Runtime.getRuntime().exec("D:\\zerofileupload.exe");// Opening the exe file made by AutoIT to input the file path into Windows Explorer and press OPEN 
	    Thread.sleep(3000);
